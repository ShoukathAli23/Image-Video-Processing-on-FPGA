...
xilinx.com:user:Colour_Filter:1.0\
...
proc create_hier_cell_frontend { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net TMDS_in_1 [get_bd_intf_pins TMDS_in] [get_bd_intf_pins dvi2rgb_0/TMDS]
  ...
  connect_bd_net -net clk_200M_1 [get_bd_pins clk_200M] [get_bd_pins dvi2rgb_0/RefClk]
...
proc create_hier_cell_hdmi_out { parentCell nameHier } {
  ...
  # Create instance: Colour_Filter_0, and set properties
  set Colour_Filter_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Colour_Filter:1.0 Colour_Filter_0 ]
  set_property -dict [ list \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Colour_Filter_0_M00_AXIS [get_bd_intf_pins Colour_Filter_0/M00_AXIS] [get_bd_intf_pins color_convert/stream_in_24]
  ...
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins S00_AXI] [get_bd_intf_pins Colour_Filter_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axis_register_slice_0_M_AXIS [get_bd_intf_pins Colour_Filter_0/S00_AXIS] [get_bd_intf_pins axis_register_slice_0/M_AXIS]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins clk_100M] [get_bd_pins Colour_Filter_0/s00_axi_aclk] [get_bd_pins frontend/clk_100M]
  connect_bd_net -net Net1 [get_bd_pins periph_resetn_clk100M] [get_bd_pins Colour_Filter_0/s00_axi_aresetn] [get_bd_pins frontend/periph_resetn_clk100M]
  connect_bd_net -net aclk_1 [get_bd_pins clk_142M] [get_bd_pins Colour_Filter_0/m00_axis_aclk] [get_bd_pins Colour_Filter_0/s00_axis_aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins color_convert/ap_clk] [get_bd_pins color_convert/control] [get_bd_pins frontend/clk_142M] [get_bd_pins pixel_unpack/ap_clk] [get_bd_pins pixel_unpack/control]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins periph_resetn_clk142M] [get_bd_pins Colour_Filter_0/m00_axis_aresetn] [get_bd_pins Colour_Filter_0/s00_axis_aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins color_convert/ap_rst_n] [get_bd_pins color_convert/ap_rst_n_control] [get_bd_pins pixel_unpack/ap_rst_n] [get_bd_pins pixel_unpack/ap_rst_n_control]
...
proc create_hier_cell_video { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M10_AXI [get_bd_intf_pins axi_interconnect_0/M10_AXI] [get_bd_intf_pins hdmi_out/S00_AXI]
...
proc create_root_design { parentCell } {
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C70000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs video/hdmi_out/Colour_Filter_0/S00_AXI/S00_AXI_reg] SEG_Colour_Filter_0_S00_AXI_reg
